#flashcards
***
Выполняет операции перемещения и переименования файлов в зависимости от особенностей использования. Используется почти так же, как и [[Cp команда терминала|cp]].
