...
- [[Утилита]] пользовательского пространства, которая читает записи каталога с помощью [[Системный вызов|системных вызовов]] семейства `getdents`.
- При использовании опций форматирования (прим: `-l`) дополнительно вызывает вызов [[Stat системный вызов|stat]] или `lstat` для каждого файла, чтобы извлечь и отобразить данные из его [[Индексный узел (inode)|inode]].
***
***Параметры.***
1. `-i` - Выводит номер [[Индексный узел (inode)|inode]] каждого файла или каталога. Полезно при работе с [[Жесткие ссылки|жесткими ссылками]].
